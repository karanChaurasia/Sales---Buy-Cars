 ...
 * @author ANITA-PC
 */
@WebServlet(urlPatterns = "/UpcomingCar")
@MultipartConfig(maxFileSize = 10*1024*1024,maxRequestSize = 20*1024*1024,fileSizeThreshold = 5*1024*1024)
public class UpcomingCar extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      int uiid=Integer.parseInt(req.getParameter("uiid"));
      String time=req.getParameter("currentDate");
      ...
      String summary=req.getParameter("txt_sum");
        ...
        System.out.println("Upcoming car data get transfer DaoImpl");
        updao.insert(up);
        resp.sendRedirect("Index.jsp#Gallery");
