 ...
 * @author ANITA-PC
 */
@WebServlet(urlPatterns = "/DoUsedCar")
@MultipartConfig(maxFileSize = 10*1024*1024,maxRequestSize = 20*1024*1024,fileSizeThreshold = 5*1024*1024)
public class DoUsedCar extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      int rating =Integer.parseInt(req.getParameter("star"));
        ...
        System.out.println("New Used car data get transfer DaoImpl");
        udao.insert(u);
     
        
        resp.sendRedirect("UsedCar.jsp");
    }
